...
OTAL_JOBS=$((NUM_PROBLEMS * NUM_SEEDS_PER_PROBLEM * NUM_METHODS * NUM_N_INITIALS * NUM_ACQS * NUM_QUANTILES * NUM_NOISIFY))
...
METHOD_IDX=$((TEMP_IDX % NUM_METHODS)); TEMP_IDX=$((TEMP_IDX / NUM_METHODS))
...
METHOD=${METHODS[$METHOD_IDX]}; N_INITIAL=${N_INITIALS[$N_INIT_IDX]}
ACQUISITION=${ACQ_FUNCS[$ACQ_IDX]}; QUANTILE_LEVEL=${QUANTILE_LEVELS[$QUANTILE_IDX]}
NOISIFY=${NOISIFY_FLAGS[$NOISIFY_IDX]}
